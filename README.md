...
# Version & progress
This translation is generated from the branch [2.0.2](https://crowdin.com/project/magento-2/de-ch#/2.0.2) at Crowdin and based on the Magento 2.0.2 sourcefiles.
There have been  6238 strings translated of the 7776 strings in the Magento source.
...
composer require magento2translations/language_de_ch:2.0.2-dev
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_de_ch/archive/2.0.2.zip).
